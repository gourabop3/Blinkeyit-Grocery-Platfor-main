  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await Axios({
        ...SummaryApi.createRechargeProduct,
        data: data,
      });
  ...
  return (
    <section className="">
      <div className="p-2 bg-white shadow-md flex items-center justify-between">
        <h2 className="font-semibold text-xl">Upload Recharge Product</h2>
      </div>
      <div className="grid p-3">
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-1">
              <label htmlFor="denomination" className="font-medium">
                Denomination (₹)
              </label>
              <input
                id="denomination"
          ...
          {data.type === "mobile_recharge" && (
            <>
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-1">
                  <label htmlFor="details.validity" className="font-medium">
                    Validity
                  </label>
                  <input
                    id="details.validity"
                ...
                <div className="grid gap-1">
                  <label htmlFor="details.data" className="font-medium">
                    Data
                  </label>
                  <input
                    id="details.data"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-1">
                  <label htmlFor="details.operator" className="font-medium">
                    Operator
                  </label>
                  <input
                    id="details.operator"
                ...
                <div className="grid gap-1">
                  <label htmlFor="details.circle" className="font-medium">
                    Circle
                  </label>
                  <input
                    id="details.circle"
          ...
          <div className="grid gap-1">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {data.details.benefits?.map((benefit, index) => (
                <div
                  key={index}
                  className="text-sm flex items-center gap-1 bg-green-100 text-green-800 px-2 py-1 rounded"
                >
                  <span>{benefit}</span>
                  <button
                    type="button"
          ...
          <div className="grid gap-1">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {data.tags?.map((tag, index) => (
                <div
                  key={index}
                  className="text-sm flex items-center gap-1 bg-purple-100 text-purple-800 px-2 py-1 rounded"
                >
                  <span>#{tag}</span>
                  <button
                    type="button"
...
export default UploadRechargeProduct;
